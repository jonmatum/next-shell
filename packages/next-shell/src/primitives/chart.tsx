  ...
  return (
    <ChartContext.Provider value={{ config }}>
      <div
        data-slot="chart"
        data-chart={chartId}
        // The `#ccc` and `#fff` hex literals below are CSS attribute
        // *selectors* matching recharts' default stroke values, not color
        // values we set. They identify the elements recharts draws so we
        // can override their stroke/fill to our semantic tokens
        // (`stroke-border`, `stroke-transparent`, etc.). The `no-raw-colors`
        // rule can't distinguish selector-hex from value-hex; the block
        // disable below covers only this className string.
        /* eslint-disable next-shell/no-raw-colors */
        className={cn(
        ...
        /* eslint-enable next-shell/no-raw-colors */
        {...props}
      >
